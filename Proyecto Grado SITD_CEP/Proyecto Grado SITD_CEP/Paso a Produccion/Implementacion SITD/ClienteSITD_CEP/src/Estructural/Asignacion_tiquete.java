...
public class Asignacion_tiquete implements Serializable {
   ...
   * @param id_modulo 
   */
  public Asignacion_tiquete(int id_tiquete, Date fecha_solicitud, Date fecha_salida, Date fecha_regreso, String ciudad_origen, String ciudad_destino, String aerolinea, int id_modulo) {
